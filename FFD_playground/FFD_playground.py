...
def main():
    ...
    for i in range(4):
        ...
        goal_coords = ffd.do_ffd(pose_of_robot_m, yaw_rot_of_robot, scan_msg_data, map_msg_data_reshape,
                                 previous_map_msg_data_reshape,
                                 map_res, x_map2or)

        previous_map_msg_data_reshape = map_msg_data_reshape
